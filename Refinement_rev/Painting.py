...
#     while True:
#         paint_colour = input("Select paint color(01 to 58) for Room {}:".format(i))
#         if paint_colour.isdigit():
#             paint_colour = int(paint_colour)
#             if int(paint_colour) >= 1 and int(paint_colour) <= 58:
#                 print("Code successful!")
#                 colour_type += [paint_colour]
#                 break
#             else:
#                 print("Code unsuccessful. Paint colour code must be integer and between 1 to 58.")
#         else:
#             print("Paint color must be numbers.")
...
variable_cost = 120 * no_rooms
total_package = base_cost + variable_cost

print(f"Variable cost for {no_rooms} rooms: {variable_cost}")
print(f"The total cost of the package is {total_package}.")
...
# highest_mark = max(numlist)
# lowest_mark = min(numlist)
# average_mark = sum(numlist) / len(numlist)
# for i in numlist:
#     if i >= 50:
#         counter += 1
...
# print(f"Number of passes: {counter}")
...
#     remaining_letters = name[1:].lower()
#     proper_name = first_letter + remaining_letters
#     namelist.append(proper_name)

# with open("proper_names.txt","a") as file:
#     for name in namelist:
#         updated = file.write(name)
